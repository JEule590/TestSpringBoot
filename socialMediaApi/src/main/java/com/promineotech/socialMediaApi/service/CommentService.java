...
public class CommentService {
	...
	public Comment createComment(com.promineotech.socialMediaApi.entity.Comment comment, Long date, Long userId, Long postId) throws Exception {
		...
		comment.setDate(new Date(postId));
