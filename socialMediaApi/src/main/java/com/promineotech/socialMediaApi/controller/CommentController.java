...
public class CommentController {
	...
	public ResponseEntity<Object> createComment(@RequestBody Comment comment, @PathVariable Long date, @PathVariable Long userId, @PathVariable Long postId) {
		try {
			return new ResponseEntity<Object>(service.createComment(comment, date, userId, postId), HttpStatus.OK);  
		  } catch (Exception e) {
